    ...
    <section className='min-h-[90vh] grid grid-cols-1 xl:grid-cols-8'>
      ...
      <div className='md:col-span-5 flex items-center justify-center p-8 xl:p-16'>
        <div className='flex flex-col gap-8'>
          <h1 className='text-4xl xl:text-7xl font-bold leading-[4.5rem] xl:leading-[7.5rem]'>
          ...
          <div className='flex flex-col md:flex-row items-center gap-4'>
            <button 
              className='w-full xl:w-auto bg-primary text-white py-2 px-8 rounded-xl text-xl hover:bg-white
               hover:text-primary transition duration-300 border-2 border-primary'
              >
              Conctact Us
            </button>
            <button 
              className='w-full xl:w-auto flex items-center text-left gap-4 py-2 px-8 rounded-xl text-xl'
              >
      ...
      <div className='md:col-span-3 flex items-center justify-center relative p-8'>
        <div>
          <img 
            src="hero.png" 
            alt="hero"  
            className='w-[450px] h-[450px] object-cover xl:-mt-28'
          />
          {/* subimagen */}
          <div className='relative bg-white shadow-xl rounded-lg p-4 flex flex-col justify-center max-w-[250px] mx-auto gap-2 -mt-12'>
            ...
            <div className="absolute -right-12 -bottom-12 -z-10">
              <div className='relative'>
                ...
                <div className='absolute bg-white w-14 h-14 left-0 top-0'></div>
              </div>
            </div>
          </div>
        </div> 
        ...
        <div 
          className="absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 
            w-[280px] h-[280px] md:w-[380px] md:h-[380px] bg-white border-[10px]
           border-primary rounded-full -z-10"
          >
        </div>
