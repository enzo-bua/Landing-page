      ...
      <div className="flex flex-col gap-4">
        ...
        <form className="w-full">
          <div className="relative">
            ...
            <input
              type="text"
              className="w-[600px] bg-gray-100 py-4 pl-10 pr-36 rounded-xl outline-none"
              placeholder="Enter your email address"
            />
            <button
              type="submit"
              className="absolute font-semibold py-2 px-6 bg-primary text-white rounded-xl top-1/2 -translate-y-1/2 right-[250px] transition duration-300 border-2 border-primary hover:bg-white hover:text-primary"
            >
              Suscribe
            </button>
          </div>
